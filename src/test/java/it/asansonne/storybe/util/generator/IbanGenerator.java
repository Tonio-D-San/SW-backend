...
import it.cybsec.app.constants.Country;
...
public class IbanGenerator {
    ...
    private static String chooseCountry(String countryNames) {
        ...
        return switch (country.getCode(countryNames)) {
            ...
            default -> throw new IllegalArgumentException("Unsupported country code: " + country.getCode(countryNames));
        };
    }

    private static String generateIbanForItaly() {
        return new Country().getCode(CODE_ITALY.getRole()) + randomDigits(2) + "A" + randomDigits(10) + randomAlphanumeric(12).toUpperCase();
    }

    private static String generateIbanForUK() {
        return new Country().getCode(CODE_GREAT_BRITAIN.getRole()) + randomDigits(2) + randomAlphanumeric(4).toUpperCase() + randomDigits(14);
    }
    ...
    private static String generateIbanForFrance() {
        return new Country().getCode(CODE_FRANCE.getRole()) + randomDigits(2) + randomDigits(10) + randomAlphanumeric(11).toUpperCase() + randomDigits(2);
    }
    ...
    private static String generateIbanForNetherlands() {
        return new Country().getCode(CODE_NETHERLANDS.getRole()) + randomDigits(2) + randomAlphanumeric(4).toUpperCase() + randomDigits(10);
    }
    ...
    private static String generateIbanForSwitzerland() {
        return new Country().getCode(CODE_SWITZERLAND.getRole()) + randomDigits(2) + randomAlphanumeric(5).toUpperCase() + randomDigits(12);
    }
    ...
    private static String generateIbanForGreece() {
        return new Country().getCode(CODE_GREECE.getRole()) + randomDigits(2) + randomAlphanumeric(7).toUpperCase() + randomDigits(16);
    }
    ...
    private static String generateIbanForCzechRepublic() {
        return new Country().getCode(CODE_CZECH_REPUBLIC.getRole()) + randomDigits(2) + randomDigits(20);
    }
    ...
    private static String generateIbanForRomania() {
        return new Country().getCode(CODE_ROMANIA.getRole()) + randomDigits(2) + randomAlphanumeric(4).toUpperCase() + randomDigits(16);
    }

    private static String generateIbanForBulgaria() {
        return new Country().getCode(CODE_BULGARIA.getRole()) + randomDigits(2) + randomAlphanumeric(4).toUpperCase() + randomDigits(16);
    }
